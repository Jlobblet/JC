...
bool jlogger_log_trace(jlogger_t self, const char *fmt, ...);
bool jlogger_log_debug(jlogger_t self, const char *fmt, ...);
bool jlogger_log_info(jlogger_t self, const char *fmt, ...);
bool jlogger_log_warn(jlogger_t self, const char *fmt, ...);
bool jlogger_log_error(jlogger_t self, const char *fmt, ...);
bool jlogger_log_fatal(jlogger_t self, const char *fmt, ...);
